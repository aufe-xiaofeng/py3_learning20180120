...
# pics = os.walk('./codeimg/').next()[2]
# pics = ["1756.png", "2846.png", "3294.png", "3882.png", "6484.png", "7814.png", "9922.png"]
pics = ['1480.jpg', '3020.jpg', '3202.jpg', '3721.jpg', '5421.jpg']
class captcha:
    ...
    def saveImg(self, name):
        self.img.save("out/"+name+"-"+self.imgname.replace("codeimg/", ""))
...
def main(pic):
    try:
        i = captcha('codeimg/'+pic)
        i.captcha()
        tname = i.imgname.replace(".jpg","").replace("codeimg/", "")
        if tname !=  i.text:
            i.saveImg(tname)
...
for re in results:
    if re[1] != re[0].replace(".png","").replace("codeimg/", ""):
        wrong += 1
